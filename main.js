...
require('./XeonCheems12.js')
nocache('../XeonCheems12.js', module => console.log(color('[ CHANGE ]', 'green'), color(`'${module}'`, 'green'), 'Updated'))
require('./main.js')
...
try{
		...
		if (update.connection == "open" || update.receivedPendingNotifications == "true") {
	        ...
	        console.log(color(`\n${themeemoji} Website: https://iqbal-ferdiansyah-dev.vercel.app`,'magenta'))
            console.log(color(`${themeemoji} GITHUB: iqblfrdsyh `,'magenta'))
            console.log(color(`${themeemoji} INSTAGRAM: @iqblfrdsyh `,'magenta'))
...
ppgroup = 'https://i.ibb.co/RBx5SQC/avatar-group-large-v2.png?q=60'
    ...
    XeonBotInc.ev.on('messages.upsert', async chatUpdate => {
        ...
        try {
            ...
            require("./XeonCheems12")(XeonBotInc, m, chatUpdate, store)
        } catch (err) {
            console.log(err)
        }
    })
